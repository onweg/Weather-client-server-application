...
QT_MOC_LITERAL(3, 48, 8), // "ApiReply"
QT_MOC_LITERAL(4, 57, 4), // "data"
QT_MOC_LITERAL(5, 62, 14), // "onSlotFindCity"
QT_MOC_LITERAL(6, 77, 21) // "onSlotFindWeatherData"

    },
    "WeatherApiClient\0sendRecivedWeatherDataFromAPI\0"
    "\0ApiReply\0data\0onSlotFindCity\0"
    "onSlotFindWeatherData"
};
...
void WeatherApiClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendRecivedWeatherDataFromAPI((*reinterpret_cast< const ApiReply(*)>(_a[1]))); break;
        ...
        {
            typedef void (WeatherApiClient::*_t)(const ApiReply & );
...
// SIGNAL 0
void WeatherApiClient::sendRecivedWeatherDataFromAPI(const ApiReply & _t1)
{
