...
#include "../WeatherApplication/src/DatabaseManager/DatabaseManager.h"
...
void DatabaseManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotSubmitCompletedWeatherDataSearchRequest((*reinterpret_cast< const WeatherHistoryItem(*)>(_a[1]))); break;
        default: ;
        }
    }
}
