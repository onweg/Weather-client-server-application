...
AuthorizationRequestDto AuthorizationRequestDomainMapper::toDto(const AuthorizationRequest& request)
{
...
AuthorizationRequest AuthorizationRequestDomainMapper::fromDto(const AuthorizationRequestDto& dto)
{
