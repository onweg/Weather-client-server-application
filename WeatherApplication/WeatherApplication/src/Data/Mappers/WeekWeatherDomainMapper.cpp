...
WeekWeatherDataDto WeekWeatherDomainMapper::toDto(
    const WeekWeatherData& domain) {
  ...
  return WeekWeatherDataDto{domain.city, dailyDtos, domain.messageError};
}

WeekWeatherData WeekWeatherDomainMapper::fromDto(
    const WeekWeatherDataDto& dto) {
