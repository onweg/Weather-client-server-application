...
class WeatherData
{
  public:
	WeatherData();
	WeatherData(double lat, double lon, const std::string &city,
	            const std::string &date, const std::string &description,
	            double temp, double feels_like, double temp_max,
	            double temp_min, double wind_speed, int humidity, int pressure,
