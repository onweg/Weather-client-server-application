...
QString WeatherUiModel::city() const { return city_; }

QString WeatherUiModel::date() const { return date_; }

QString WeatherUiModel::description() const { return description_; }

double WeatherUiModel::lat() const { return lat_; }

double WeatherUiModel::lon() const { return lon_; }

double WeatherUiModel::temp() const { return temp_; }

double WeatherUiModel::feelsLike() const { return feelsLike_; }

double WeatherUiModel::tempMax() const { return tempMax_; }

double WeatherUiModel::tempMin() const { return tempMin_; }

double WeatherUiModel::windSpeed() const { return windSpeed_; }

int WeatherUiModel::humidity() const { return humidity_; }

int WeatherUiModel::pressure() const { return pressure_; }

QString WeatherUiModel::messageError() const { return messageError_; }
