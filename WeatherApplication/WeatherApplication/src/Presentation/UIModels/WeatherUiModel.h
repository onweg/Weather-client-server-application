...
class WeatherUiModel : public QObject
{
	...
	Q_PROPERTY(double feelsLike READ feelsLike WRITE setFeelsLike NOTIFY
	               feelsLikeChanged)
	Q_PROPERTY(
	    double tempMax READ tempMax WRITE setTempMax NOTIFY tempMaxChanged)
	Q_PROPERTY(
	    double tempMin READ tempMin WRITE setTempMin NOTIFY tempMinChanged)
	...
	Q_PROPERTY(
	    int pressure READ pressure WRITE setPressure NOTIFY pressureChanged)
