...
QString WeekWeatherUiModel::city() const { return city_; }

QString WeekWeatherUiModel::messageError() const { return messageError_; }

QList<QObject *> WeekWeatherUiModel::dailyWeather() const { return dailyWeather_; }
