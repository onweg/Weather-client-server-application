...
WeekWeatherDataDto WeatherJsonConverter::parseWeekWeather(const QJsonObject& jsonObj) {
    ...
    QMap<QString, WeatherDataDto> dailyData = groupForecastsByDay(forecasts, cityName);
...
QMap<QString, WeatherDataDto> WeatherJsonConverter::groupForecastsByDay(
...
WeatherDataDto WeatherJsonConverter::parseWeatherData(
...
bool WeatherJsonConverter::isBetterMatch(int currentHour, const QMap<QString, WeatherDataDto>& dailyData, const QString& dateKey) {
...
QStringList WeatherJsonConverter::sortedKeys(const QMap<QString, WeatherDataDto>& dailyData) {
