...
private:
    ...
    static QMap<QString, WeatherDataDto> groupForecastsByDay(const QJsonArray& forecasts,
    ...
    static void selectBestForecastForDay(const WeatherDataDto& data,
    ...
    static bool isBetterMatch(int currentHour,
                              const QMap<QString,
                              WeatherDataDto>& dailyData,
                              const QString& dateKey);
    static QStringList sortedKeys(const QMap<QString,
                                  WeatherDataDto>& dailyData);
